...
SliderBackground();$('#burger').on("click",function(){$(".fullscreen-nav-container").slideToggle(300);});$(".fullscreen-nav-holder a, .turn-home").on("click",function(){$("#burger").trigger("click");});$(window).on('scroll',function(){var counter=0;var tracker=0;$('section').each(function(){if((counter==2||counter==3||counter==4||counter==14||counter==15)&&$(window).scrollTop()+80>=$(this).offset().top){tracker++;$('.menu-item').removeClass('active');$(".menu-item."+tracker).addClass("active");$(".mobile-menu-item").removeClass("active");$(".mobile-menu-item."+tracker).addClass("active");}
